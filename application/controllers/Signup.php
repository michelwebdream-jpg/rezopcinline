...
class Signup extends CI_Controller
{
    ...
    function membres(){
        if (!$this->session->userdata('login') || !$this->session->userdata('logged')){
            ...
            $this->email->from('info@web-dream.fr','REZO+ PC Inline - Web-Dream');
            $this->email->to('info@web-dream.fr');
            $this->email->subject('Connexion à REZO+ PC Inline');
            
            $user_logged=$this->session->userdata('deliverdata');
            ...
            $this->email->message("Bonjour,<br />une connexion à REZO+ PC Inline vient d'être effectuée.<br />Voiciles détails :<br />".$message_connexion);
