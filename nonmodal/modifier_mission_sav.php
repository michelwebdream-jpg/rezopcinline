...
<details close>
          ...
          <p id="summary_edition_mission" style="text-align:center;font-size:14px;">Vous pouvez modifier le nom de cette mission. Vous pouvez aussi ajouter des personnes ou en enlever.<br />Pour enregistrer les modification cliquez sur le bouton "sauvegarder" en bas de page.</p>
        <p id="summary_nouvelle_mission" style="text-align:center;font-size:14px;">Vous devez renseigner le nom de cette mission. Vous devez aussi ajouter des personnes.<br />Pour enregistrer la nouvelle mission, cliquez sur le bouton "sauvegarder" en bas de page.</p>
        </details>
