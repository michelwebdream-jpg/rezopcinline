...
function actualise_table_invisible(data_table_list_des_victimes){
    ...
    for (i=0;i<data_table_list_des_victimes.length;i++){
        ...
        var bilan_circonstanciel=data_table_list_des_victimes[i].bilan_circonstanciel;
        bilan_circonstanciel=bilan_circonstanciel.replace(/<br>/g, '\n');
        data_table_list_des_victimes[i].bilan_circonstanciel=bilan_circonstanciel;
