...
<div>
    ...
    <div class="formulaire_saisie_activite">
        ...
        <input type="text" name="nom_activite" id="input_nom_activite" value="" style="display:inline-block;width:100%;margin-left: 10px;"  maxlength="256"/><br /><br />
        </p>
        <p>
        <label for="input_nom_responsable_activite">Nom du responsable PC : </label>
        <input type="text" name="nom_responsable_activite" id="input_nom_responsable_activite" value="" style="display:inline-block;width:100%;margin-left: 10px;"   maxlength="70" /><br /><br />
        </p>
        <p>
        <label for="input_adresse_activite">Adresse de l'activité : </label>
        <textarea name="adresse_activite" id="input_adresse_activite" value="" cols="50" rows="4" maxlength="256" style="display:inline-block;width:100%;margin-left: 10px;"/>
        </p>
        <p>
            <label for="input_remarque_activite">Remarques<br>Informations diverses : </label>
        <textarea name="remarque_activite" id="input_remarque_activite" value="" cols="50" rows="5" maxlength="256" style="display:inline-block;width:100%;margin-left: 10px;"/>
        </p>
    </div>
    <hr />
...
function enregistre_activite(){
    if ($('#input_nom_activite').val()==="")
	{
		...
		{
			enregistre_modification_activite_sur_serveur(Id_editing_activite_edition,nom_nouvelle_activite,nom_responsable_activite,adresse_activite,remarque_activite,listofcodeasauver,temp1.length-1);
		}else{
			sauve_nouvelle_activite_sur_serveur(nom_nouvelle_activite,nom_responsable_activite,adresse_activite,remarque_activite,listofcodeasauver,temp1.length-1);
		}
...
function sauve_nouvelle_activite_sur_serveur(nom_de_lactivite,nom_responsable_activite,adresse_activite,remarque_activite,listofcodeasauver,Qte){
...
function enregistre_modification_activite_sur_serveur(Id, nom_de_lactivite,nom_responsable_activite,adresse_activite,remarque_activite,listofcodeasauver,Qte){
