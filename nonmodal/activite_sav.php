...
<h1 style=" overflow: hidden; float: left;">Mes activités</h1>
...
<div style="float:right;display: flex;align-items: center;margin-right:10px;"><a href ="#" id="bouton_creer_nouvelle_activite" class="bouton_fermer"> + Créer une nouvelle activité </a></p>
</div>
  ...
  table_activite = $('#tableau_activite_id').DataTable({
      ...
      "columnDefs": [ 
        ...
        },
          {
            ...
            "data": null,
              "orderable": false,
            "defaultContent": "<button id='button_geolocaliser'>Géolocaliser</button>"
        },
          {
            "targets": 6,
            "data": null,
              "orderable": false,
            "defaultContent": "<button id='button_historique'>Historique</button>"
        },
          {
            "targets": 7,
            "data": null,
              "orderable": false,
            "defaultContent": "<button id='button_bilan_activite'>Bilan</button>"
        } ],
        ...
        for (i=0; i<trame.length;i++)
            {
                ...
                data_table_list_des_activites.push({activite:titre[i], utilisateur:qte[i], date_creation:date[i],c6:id[i], c7:membres[i]});
            }
