...
<table border="0" style="border-collapse:collapse;">
    ...
    <td  valign="bottom">
        <details close>
          ...
          <p style="text-align:center;font-size:14px;">Pour placer un marqueur sur la carte, cliquez sur un symbole, puis déplacez le sur la carte en maintenant le bouton de la souris enfoncé. Lachez le bouton de la souris pour le déposer.<br />Pour le supprimer, cliquer une fois dessus. Pour déplacer un marqueur sur la carte,<br />cliquez sur le marqueur et sans relacher le bouton de la souris, déplacez le marqueur.</p>
        </details>
